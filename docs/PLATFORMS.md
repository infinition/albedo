...
| macOS 12+ Intel / Apple Silicon | Universal `Albedo.app` in DMG | `Contents/PlugIns/AlbedoThumbnail.appex`, registered with Quick Look |
...
The macOS and Linux native jobs have **not been executed from this Windows
workspace**. Their results, and interactive Finder/Nautilus/Dolphin behavior,
remain validation work on those operating systems. The workflow must pass before
